...
def main():
    ...
    ffmpeg_path = os.path.join(base_dir, "ffmpeg-n6.1-latest-win64-gpl-6.1", "bin", "ffmpeg.exe")  # Path to FFmpeg relative to project
    ...
    input_video_path = os.path.join(input_folder,"TestIP.mp4")
    print(input_video_path)
    # output_video_path = "C:\\Users\\username\\Downloads\\Output.mp4"
    output_video_path = os.path.join(output_folder,"TestIPO.mp4")  # Specify the output video file name here
    ...
    noise_threshold = -30  # Configurable silence threshold
